...
- **Puzzle Types:**
  - Riddles to solve
  - Code locks to crack
  - Symbol patterns to decipher
  - Hidden object discovery
  - Inventory-based puzzles

- **Item Collection System** - Find items throughout the mansion to unlock new areas

- **Time Tracking** - Monitor your escape time and remaining minutes
...
```bash
git clone https://github.com/YOUR-USERNAME/horror-escape-room.git
cd horror-escape-room
```
...
3. Examine objects and solve puzzles
4. Collect items and use them wisely
...
- Pay attention to hints in the environment
...
```
main.py
├── EscapeRoomGame (Main Game Class)
├── Room 1: Dusty Library
├── Room 2: Dark Basement
├── Room 3: Haunted Bedroom
...
**Happy Escaping! Can you solve all the puzzles and escape the mansion? 🔓**
